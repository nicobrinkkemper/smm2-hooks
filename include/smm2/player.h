...
namespace off {
    constexpr uint32_t pos_x       = 0x228;  // float
    constexpr uint32_t pos_y       = 0x22C;  // float
    constexpr uint32_t pos_z       = 0x230;  // float
    ...
    constexpr uint32_t prev_state  = 0x3FC;  // u32 (StateMachine+0x0C)
